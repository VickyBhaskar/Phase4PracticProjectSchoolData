...
namespace SchoolDataTest
{
    ...
    public class SchoolUnitTest
    {
        ...
        public void AddStudent()
        {
            ...
            var student = new Student { StudentId = 1, StudentName = "Vicky Kumar", Class = "Class 12th" };
        ...
        {
            var schoolManagement = new SchoolManagement();
            var teacher = new Teacher { TeacherId = 1, TeacherName = "Raju" };
        ...
        public void StudentMockTest()
        {
            ...
            studentMock.SetupGet(s => s.StudentName).Returns("Bhaskar");
            studentMock.SetupGet(s => s.Class).Returns("Class 12th");
        ...
        public void TeacherMockTest()
        {
            ...
            teacherMock.SetupGet(s => s.TeacherName).Returns("Niraj");
